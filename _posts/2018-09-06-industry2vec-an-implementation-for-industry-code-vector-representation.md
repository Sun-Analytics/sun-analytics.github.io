...
<figure class="align-center">
    <img style="width: 40%" class="align-center" src="{{ site.url }}{{ site.baseurl }}/assets/images/posts/industrycode2vec/arch.png" alt="">
...
<figure class="align-center">
    <img style="width: 40%" class="align-center" src="{{ site.url }}{{ site.baseurl }}/assets/images/posts/industrycode2vec/company-tree.png" alt="">
...
<figure class="align-center">
    <img style="width: 40%" class="align-center" src="{{ site.url }}{{ site.baseurl }}/assets/images/posts/industrycode2vec/naics-description-embedding.png" alt="">
...
<figure class="align-center">
    <img style="width: 40%" class="align-center" src="{{ site.url }}{{ site.baseurl }}/assets/images/posts/industrycode2vec/multi-loss.png" alt="">
...
<figure class="align-center">
    <img style="width: 70%" class="align-center" src="{{ site.url }}{{ site.baseurl }}/assets/images/posts/industrycode2vec/alternative.png" alt="">
